...
{
    //vector to storage tensors and dimensions
    std::vector<std::pair<std::string, std::vector<int>>> DimsList;

    //Inputand output sizes for allocating memory
    ...
    //Iterate over all the input tensors and print their names and dimensions
    ...
    //Iterator over the output tensors and print their names
...
{
    std::cout << "Starting TensorRT Engine creation with the following parameters:" << std::endl;
